  ...
  try {
    ...
    if (raw) {
      try {
        ...
        console.error("deleteAccount JSON parse error:", parseErr, raw);
    ...
    if (!response.ok || !data || data.success !== true) {
      const message = (data && data.error) || "Failed to delete account";
    ...
    console.error("deleteAccount request error:", err);
